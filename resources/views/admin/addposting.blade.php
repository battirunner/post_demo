        ...
        <div class="row content">
            ...
            <div class="col-sm-9 col-xs-9">
                ...
                <form role="form" action="{{route('admin.postadd')}}" method="POST" enctype="multipart/form-data" >
                    ...
                    @include('admin.partials.postinfoinput')
                    @include('admin.partials.postcheckoptions')
                    <div class="form-group tag-input-area">
                        <label for="city_tag">{{__('write something and press enter to convert into tag')}}</label>
